...
interface TelecallerPerformanceChartProps {
...
export const TelecallerPerformanceChart: React.FC<TelecallerPerformanceChartProps> = ({ data }) => {
  const telecallerCourses = data.data
    .filter(course => course.count > 0)
    .sort((a, b) => b.count - a.count);
  
  const telecallerByType = data.data.reduce((acc, course) => {
